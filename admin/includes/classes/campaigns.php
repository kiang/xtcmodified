<?php
/* -----------------------------------------------------------------------------------------
   $Id: campaigns.php 1251 2010-09-01 12:05:07Z dokuman $
   ...
   (c) 2006 XT-Commerce (campaigns.php 1176 2005-08-22)
...
class campaigns {
    ...
    function getTotalSells() {
        ...
        $status = "";
        if ($this->status > 0) $status = " and o.orders_status='" . $this->status . "'";
