<?php
/* --------------------------------------------------------------
   $Id: footer.php 1286 2010-09-08 10:00:24Z dokuman $   
...
*/
?>xtcModified &copy; 2009-<?php echo date("Y"); ?> <a href="http://www.xtc-modified.org" target="_blank">xtcModified</a>
<br />based on E-Commerce Engine Copyright &copy; 2006 <a href="http://www.xt-commerce.com" target="_blank">xt:Commerce</a>
<br />xtcModified provides no warranty and is redistributable under the <a href="http://www.fsf.org/licenses/gpl.txt" target="_blank">GNU General Public License</a></td>
  </tr>
  <tr>
