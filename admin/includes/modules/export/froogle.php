    ...
    function process($file) {
        ...
        while ($products = xtc_db_fetch_array($export_query)) {
            ...
            */
            ...
            //-- Shopstat URLS ----//
            $products['products_id'] . "\t" . $products['products_name'] . "\t" . $products_description . "\t" . $image . "\t" . substr($cat, 0, strlen($cat) - 2) . "\t" . number_format($products_price, 2, '.', '') . "\t" . neu . "\t" . $products['manufacturers_name'] . "\n";
        }
        // create File
