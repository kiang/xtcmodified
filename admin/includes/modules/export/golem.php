...
define('MODULE_GOLEM_TEXT_DESCRIPTION', 'Export - Golem.de (XML)<br /><strong>Format:</strong><br />');
...
define('MODULE_GOLEM_CURRENCY_TITLE', 'W&auml;hrung');
define('MODULE_GOLEM_CURRENCY_DESC', 'Welche W&auml;hrung soll exportiert werden?');
