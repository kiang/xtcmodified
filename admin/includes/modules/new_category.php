...
if (isset($_GET['cID']) && (!$_POST)) {
    $category_query = xtc_db_query("select * from " . TABLE_CATEGORIES . " c, " . TABLE_CATEGORIES_DESCRIPTION . " cd
...
<?php for ($i = 0;$i < sizeof($languages);$i++) { ?>
          <tr>
            <td class="main" width="180"><?php if ($i == 0) {
