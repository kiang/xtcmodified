<?php
/* -----------------------------------------------------------------------------------------
   $Id: module_export.php 1497 2010-11-15 18:06:58Z dokuman $
...
<?php /*<!-- BOF - Tomcraft - 2009-06-10 - added some missing alternative text on admin icons -->
        ...
        */ ?>
            ...
            echo '<a href="' . xtc_href_link(FILENAME_MODULE_EXPORT, 'set=' . $set . '&module=' . $class) . '">' . xtc_image(DIR_WS_IMAGES . 'icon_info.gif', IMAGE_ICON_INFO) . '</a>';
        } ?> </td>
