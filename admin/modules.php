<?php
/* --------------------------------------------------------------
   $Id: modules.php 1495 2010-11-13 21:24:17Z dokuman $
        ...
        if (xtc_class_exists($class)) {
            ...
            if ($module->check() > 0) {
                if ($module->sort_order > 0) {
                    ...
                    if (!isset($installed_modules[$module->sort_order])) $installed_modules[$module->sort_order] = $file;
                    else $installed_modules[] = $file;
...
?>
            ...
            echo $module->title;
            if (isset($module->icons_available)) echo '<br />' . $module->icons_available;
?></td>
...
<?php /*<!-- BOF - Tomcraft - 2009-06-10 - added some missing alternative text on admin icons -->
            ...
            */ ?>
                ...
                echo '<a href="' . xtc_href_link(FILENAME_MODULES, 'set=' . $set . '&module=' . $class) . '">' . xtc_image(DIR_WS_IMAGES . 'icon_info.gif', IMAGE_ICON_INFO) . '</a>';
            } ?>&nbsp;</td>
            ...
            while (list(, $value) = each($mInfo->keys)) {
                ...
                if ($value['use_function']) {
                    ...
                    if (preg_match('/->/', $use_function)) { // Hetfield - 2009-08-19 - replaced deprecated function ereg with preg_match to be ready for PHP >= 5.3
                        ...
                        $keys.= xtc_call_function($class_method[1], $value['value'], $ {
                            $class_method[0]
                        });
                    } else {
