<?php
/* -----------------------------------------------------------------------------------------
   $Id: print_packingslip.php 1250 2010-09-01 11:55:30Z dokuman $
...
while ($order_data_values = xtc_db_fetch_array($order_query)) {
    ...
    $order_data[] = array('PRODUCTS_MODEL' => $order_data_values['products_model'], 'PRODUCTS_NAME' => $order_data_values['products_name'], 'PRODUCTS_ATTRIBUTES' => $attributes_data, 'PRODUCTS_ATTRIBUTES_MODEL' => $attributes_model,
    //DokuMan - 2010-09-01 - FEATURE: #0000215 shipping time in admin print order/packingslip
    'PRODUCTS_SHIPPING_TIME' => $order_data_values['products_shipping_time'],
    //DokuMan - 2010-09-01 - FEATURE: #0000215 shipping time in admin print order/packingslip
    'PRODUCTS_PRICE' => xtc_format_price_order($order_data_values['final_price'], 1, $order->info['currency']), 'PRODUCTS_QTY' => $order_data_values['products_quantity']);
}
