<?php
/* --------------------------------------------------------------
   $Id: stats_sales_report.php 1495 2010-11-13 21:24:17Z dokuman $
...
?>
                      <td class="dataTableContent" align="right"><?php echo /*$info[0]['order'];*/
    (isset($info[0]['order']) ? $info[0]['order'] : '&nbsp;'); /*Dokuman - 2010-10-31 - fix empty <td>line without visible dashes*/ ?></td>
    ...
    (isset($info[$last - 1]['totitem']) ? $info[$last - 1]['totitem'] : '&nbsp;'); /*Dokuman - 2010-10-31 - Undefined offset: -1 */ ?></td>
                      <td class="dataTableContent" align="right"><?php echo /*$currencies->format($info[$last - 1]['totsum']);*/
    (isset($info[$last - 1]['totsum']) ? $currencies->format($info[$last - 1]['totsum']) : '&nbsp;'); /*Dokuman - 2010-10-31 - Undefined offset: -1 */ ?></td>
