...
if (!is_array($data)) {
    if ($data == 'ERROR_NO_PASSWORD') echo MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_ERROR_WRONG_PASSWORD;
    if ($data == 'ERROR_WRONG_HASH') echo MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_ERROR_WRONG_HASH;
    else echo $data;
...
function getStatusId($status) {
    ...
    else return DEFAULT_ORDERS_STATUS_ID;
}
?>