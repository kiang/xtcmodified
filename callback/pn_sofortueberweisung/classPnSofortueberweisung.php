...
class classPnSofortueberweisung {
     ...
     */
    function getPaymentUrl($userId, $projectId, $amount, $currency, $reason1 = '', $reason2 = '', $userVariable0 = '', $userVariable1 = '', $userVariable2 = '', $userVariable3 = '', $userVariable4 = '', $userVariable5 = '', $senderHolder = '', $senderAccountNumber = '', $senderBankCode = '', $senderCountryId = '') {
        $data = $this->getPaymentParameters($userId, $projectId, $amount, $currency, $reason1, $reason2, $userVariable0, $userVariable1, $userVariable2, $userVariable3, $userVariable4, $userVariable5, $senderHolder, $senderAccountNumber, $senderBankCode, $senderCountryId);
        $dataString = '';
    ...
    function getPaymentUrlSV($userId, $projectId, $amount, $currency, $reason1 = '', $reason2 = '', $userVariable0 = '', $userVariable1 = '', $userVariable2 = '', $userVariable3 = '', $userVariable4 = '', $userVariable5 = '') {
        $data = $this->getPaymentParametersSV($userId, $projectId, $amount, $currency, $reason1, $userVariable0, $userVariable1, $userVariable2, $userVariable3, $userVariable4, $userVariable5);
        $dataString = '';
        foreach ($data as $key => $value) {
            $dataString.= $key . '=' . urlencode($value) . '&';
        }
     ...
     */
    function getPaymentParameters($userId, $projectId, $amount, $currency, $reason1 = '', $reason2 = '', $userVariable0 = '', $userVariable1 = '', $userVariable2 = '', $userVariable3 = '', $userVariable4 = '', $userVariable5 = '', $senderHolder = '', $senderAccountNumber = '', $senderBankCode = '', $senderCountryId = '') {
        $tmparray = array($userId, $projectId, $senderHolder, $senderAccountNumber, $senderBankCode, $senderCountryId, $amount, $currency, $reason1, $reason2, $userVariable0, $userVariable1, $userVariable2, $userVariable3, $userVariable4, $userVariable5, $this->password);
    ...
    function getPaymentParametersSV($userId, $projectId, $amount, $currency, $reason = '', $userVariable0 = '', $userVariable1 = '', $userVariable2 = '', $userVariable3 = '', $userVariable4 = '', $userVariable5 = '', $senderHolder = '', $senderAccountNumber = '', $senderBankCode = '', $senderCountryId = '', $sender_bank_bic = '', $sender_iban = '') {
        $tmparray = array($userId, $projectId, $senderHolder, $senderAccountNumber, $senderBankCode, $sender_bank_bic, $sender_iban, $senderCountryId, $amount, $currency, $reason, $userVariable0, $userVariable1, $userVariable2, $userVariable3, $userVariable4, $userVariable5, $this->password);
        $hash = $this->generateHash(implode("|", $tmparray));
        $data['user_id'] = $userId;
        $data['project_id'] = $projectId;
        $data['amount'] = $amount;
    ...
    function getNotification() {
        $fields = array('transaction', 'user_id', 'project_id', 'sender_holder', 'sender_account_number', 'sender_bank_code', 'sender_bank_name', 'sender_bank_bic', 'sender_iban', 'sender_country_id', 'recipient_holder', 'recipient_account_number', 'recipient_bank_code', 'recipient_bank_name', 'recipient_bank_bic', 'recipient_iban', 'recipient_country_id', 'international_transaction', 'amount', 'currency_id', 'reason_1', 'reason_2', 'security_criteria', 'user_variable_0', 'user_variable_1', 'user_variable_2', 'user_variable_3', 'user_variable_4', 'user_variable_5', 'created');
    ...
    function getNotificationSV() {
        $fields = array('transaction', 'user_id', 'project_id', 'sender_holder', 'sender_account_number', 'sender_bank_code', 'sender_bank_name', 'sender_bank_bic', 'sender_iban', 'sender_country_id', 'recipient_holder', 'recipient_account_number', 'recipient_bank_code', 'recipient_bank_name', 'recipient_bank_bic', 'recipient_iban', 'recipient_country_id', 'amount', 'currency_id', 'reason', 'user_variable_0', 'user_variable_1', 'user_variable_2', 'user_variable_3', 'user_variable_4', 'user_variable_5', 'created');
        //http-notification with status
        if (array_key_exists('status', $_POST) && !empty($_POST['status'])) {
            array_push($fields, 'status', 'status_modified');
        }
    ...
    function getSupportedHashAlgorithm() {
        ...
        if (is_array($algorithms)) return $algorithms[0];
        else return ''; //no hash function found
    ...
    function getSupportedHashAlgorithms() {
        $algorithms = array();
        if (function_exists('hash') && in_array('sha512', hash_algos())) $algorithms[] = 'sha512';
        if (function_exists('hash') && in_array('sha256', hash_algos())) $algorithms[] = 'sha256';
     ...
     * @return string
     */
    function getAutoInstallPage($projectName, $projectHomepage, $projectEmail, $projectLanguage, $currency, $cancelLink, $successLink, $notificationLink, $backLink, $shopSystemId = '208') {
...
';
    ...
    function generateHash($data) {
        if ($this->hashfunction == 'sha1') return sha1($data);
        //mcrypt installed?
        if (function_exists('hash') && in_array($this->hashfunction, hash_algos())) return hash($this->hashfunction, $data);
