<?php
/* -----------------------------------------------------------------------------------------
   $Id: checkout_process.php 1224 2010-08-28 22:39:15Z dokuman $
...
if (isset($_SESSION['tmp_oID']) && is_numeric($_SESSION['tmp_oID'])) {
    ...
    if ($tmp) $payment_modules->payment_action();
}
if (!$tmp) {
