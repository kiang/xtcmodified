<?php
/* -----------------------------------------------------------------------------------------
   $Id: create_guest_account.php 1551 2010-12-04 11:23:46Z dokuman $
...
if (isset($_POST['action']) && ($_POST['action'] == 'process')) {
    ...
    if (isset($_SESSION['xtb0']['DEFAULT_CUSTOMER_GROUP']) && $_SESSION['xtb0']['DEFAULT_CUSTOMER_GROUP'] != '') $customers_status = $_SESSION['xtb0']['DEFAULT_CUSTOMER_GROUP'];
