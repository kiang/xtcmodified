<?php
/* -----------------------------------------------------------------------------------------
   $Id: download.php 1180 2010-08-19 08:48:06Z dokuman $   
...
if (!isset($_SESSION['customer_id'])) die('not allowed');
...
if (!xtc_db_num_rows($downloads_query)) die();
...
if (!file_exists(DIR_FS_DOWNLOAD . $downloads['orders_products_filename'])) die('file not found');
