...
// cache check
if(file_exists(DIR_FS_DOCUMENT_ROOT.CACHEFILE) 
  && time() - filemtime(DIR_FS_DOCUMENT_ROOT.CACHEFILE) < CACHEDAYS*24*3600) {
  // show cached content
...
while ($listing = xtc_db_fetch_array($listing_query, true)) {
  ...
  if($listing['manufacturers_id'] > '0')
    $marke = xtc_db_fetch_array(xtc_db_query("SELECT manufacturers_name 
