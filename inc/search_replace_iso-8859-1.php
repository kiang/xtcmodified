...
function shopstat_getRegExps(&$search, &$replace) {
    ...
    "'&(lsquo|#8216);'i", //-- einfaches Anführungszeichen links 	### NICHT in iso-8859-1 enthalten ###
    "'&(rsquo|#8217);'i", //-- einfaches Anführungszeichen rechts 	### NICHT in iso-8859-1 enthalten ###
    "'&(sbquo|#8218);'i", //-- Einfaches, gekrümmtes Anführungszeichen unten 	### NICHT in iso-8859-1 enthalten ###
    "'&(ldquo|#8220);'i", //-- doppeltes Anführungszeichen links  ### NICHT in iso-8859-1 enthalten ###
    ...
    if (SPECIAL_CHAR_FR) {
        ...
        "'&(Yuml|#376);'i", //Großes Y mit Diaeresis ### NICHT in iso-8859-1 enthalten ###
        "'&(yuml|#255);|ÿ'i"
    ...
    //*****************************************************************
    $replace = array("-", //--Kaufmännisches Und mit Blanks
