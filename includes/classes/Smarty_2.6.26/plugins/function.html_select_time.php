...
function smarty_function_html_select_time($params, &$smarty) {
    ...
    if ($display_hours) {
        ...
        for ($i = 0, $for_max = count($hours);$i < $for_max;$i++) $hours[$i] = sprintf('%02d', $hours[$i]);
    ...
    if ($display_minutes) {
        ...
        for ($i = 0, $for_max = count($all_minutes);$i < $for_max;$i+= $minute_interval) $minutes[] = sprintf('%02d', $all_minutes[$i]);
    ...
    if ($display_seconds) {
        ...
        for ($i = 0, $for_max = count($all_seconds);$i < $for_max;$i+= $second_interval) $seconds[] = sprintf('%02d', $all_seconds[$i]);
