...
class cc_validation {
    ...
    function validate($number, $expiry_m, $expiry_y) {
        ...
        if (preg_match('/^4[0-9]{12}([0-9]{3})?$/', $this->cc_number)) { // Hetfield - 2009-08-19 - replaced deprecated function ereg with preg_match to be ready for PHP >= 5.3
            $this->cc_type = 'Visa';
            if (strtolower(MODULE_PAYMENT_CC_ACCEPT_VISA) != 'true') return -8;
            ...
            if (strtolower(MODULE_PAYMENT_CC_ACCEPT_MASTERCARD) != 'true') return -8;
            ...
            if (strtolower(MODULE_PAYMENT_CC_ACCEPT_AMERICANEXPRESS) != 'true') return -8;
            ...
            if (strtolower(MODULE_PAYMENT_CC_ACCEPT_DINERSCLUB) != 'true') return -8;
            ...
            if (strtolower(MODULE_PAYMENT_CC_ACCEPT_DISCOVERNOVUS) != 'true') return -8;
            ...
            $this->cc_type = 'JCB';
            if (strtolower(MODULE_PAYMENT_CC_ACCEPT_JCB) != 'true') return -8;
            ...
            if (strtolower(MODULE_PAYMENT_CC_ACCEPT_OZBANKCARD) != 'true') return -8;
        } else {
            return -1;
        }
