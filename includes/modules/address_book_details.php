<?php
/* -----------------------------------------------------------------------------------------
   $Id: address_book_details.php 1412 2010-10-13 15:01:47Z dokuman $
...
if (ACCOUNT_STATE == 'true') {
    ...
    if ($process == true) {
        ...
        //BOF - DokuMan - 2010-10-13 - check for $entry['entry_country_id']
        $state_input = '';
        if (isset($entry['entry_country_id']))
        //EOF - DokuMan - 2010-10-13 - check for $entry['entry_country_id']
