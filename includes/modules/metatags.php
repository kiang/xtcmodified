<?php
/* -----------------------------------------------------------------------------------------
   $Id: metatags.php 1578 2010-12-13 16:06:33Z dokuman $
...
// ---------------------------------------------------------------------------------------
$pagesToShow = array(FILENAME_DEFAULT, FILENAME_PRODUCT_INFO, FILENAME_CONTENT, FILENAME_ADVANCED_SEARCH_RESULT, FILENAME_SPECIALS, FILENAME_PRODUCTS_NEW);
// ---------------------------------------------------------------------------------------
//  Ende Konfiguration
// ---------------------------------------------------------------------------------------
...
if (basename($_SERVER['SCRIPT_NAME']) == FILENAME_DEFAULT && empty($_GET['cat']) && empty($_GET['cPath']) && empty($_GET['manufacturers_id'])) {
    ...
    case FILENAME_PRODUCT_INFO:
        if ($product->isProduct()) {
            ...
            if (!empty($product->data['products_meta_title'])) {
                ...
                //BOF - DokuMan - 2010-12-13 - added meta pagination
                ...
                //EOF - DokuMan - 2010-12-13 - added meta pagination
