<?php
/* -----------------------------------------------------------------------------------------
   $Id: ot_gv.php 1417 2010-10-14 16:23:06Z dokuman $
...
class ot_gv {
    ...
    function use_credit_amount() {
        $output_string = '' . $_SESSION['cot_gv'] = false;
    ...
    function collect_posts() {
        ...
        if (isset($_POST['submit_redeem_x']) && $gv_result['coupon_type'] == 'G') xtc_redirect(xtc_href_link(FILENAME_CHECKOUT_PAYMENT, 'error_message=' . urlencode(ERROR_NO_REDEEM_CODE), 'SSL'));
    }
