...
class amoneybookers {
    ...
    function __construct() {
        ...
        $this->icons_available = xtc_image(DIR_WS_ICONS . 'cc_amex_small.jpg') . ' ' . xtc_image(DIR_WS_ICONS . 'cc_mastercard_small.jpg') . ' ' . xtc_image(DIR_WS_ICONS . 'cc_visa_small.jpg') . ' ' . xtc_image(DIR_WS_ICONS . 'cc_diners_small.jpg') . ' ' . xtc_image(DIR_WS_ICONS . 'giropay_small.jpg') . ' ' . xtc_image(DIR_WS_ICONS . 'visa_electron_small.jpg') . ' ' . xtc_image(DIR_WS_ICONS . 'swift_small.jpg') . ' ' . xtc_image(DIR_WS_ICONS . 'elv_small.jpg') . ' ' . xtc_image(DIR_WS_ICONS . 'cheque_small.jpg');
        $this->repost = false;
        $this->Error = '';
        $this->oID = 0;
        $this->debug = false;
    ...
    function selection() {
        ...
        foreach ($icons as $key => $val) $accepted.= xtc_image(DIR_WS_ICONS . $val) . ' ';
        $content = array_merge($content, array(array('title' => ' ', 'field' => '<div align="right"><a href="' . $this->landingPage . '" target="_blank">' . $this->logo . '</a></div>')));
        $content = array_merge($content, array(array('title' => '', 'field' => MODULE_PAYMENT_AMONEYBOOKERS_TEXT_INFO_1)));
        $content = array_merge($content, array(array('title' => ' ', 'field' => $accepted)));
        $content = array_merge($content, array(array('title' => xtc_image(DIR_WS_ICONS . 'arrow_accepted.jpg'), 'field' => MODULE_PAYMENT_AMONEYBOOKERS_TEXT_INFO_2)));
        $content = array_merge($content, array(array('title' => xtc_image(DIR_WS_ICONS . 'arrow_accepted.jpg'), 'field' => MODULE_PAYMENT_AMONEYBOOKERS_TEXT_INFO_3)));
        $content = array_merge($content, array(array('title' => xtc_image(DIR_WS_ICONS . 'arrow_accepted.jpg'), 'field' => MODULE_PAYMENT_AMONEYBOOKERS_TEXT_INFO_4)));
        $content = array_merge($content, array(array('title' => xtc_image(DIR_WS_ICONS . 'arrow_accepted.jpg'), 'field' => MODULE_PAYMENT_AMONEYBOOKERS_TEXT_INFO_5)));
    ...
    function get_error() {
        global $_GET;
        $error = array('title' => MODULE_PAYMENT_AMONEYBOOKERS_TEXT_ERROR, 'error' => stripslashes(urldecode($_GET['error'])));
        return $error;
    }
    function check() {
    ...
    function keys() {
        return array('MODULE_PAYMENT_AMONEYBOOKERS_STATUS', 'MODULE_PAYMENT_AMONEYBOOKERS_EMAILID', 'MODULE_PAYMENT_AMONEYBOOKERS_PWD', 'MODULE_PAYMENT_AMONEYBOOKERS_MERCHANTID', 'MODULE_PAYMENT_AMONEYBOOKERS_LANGUAGE', 'MODULE_PAYMENT_AMONEYBOOKERS_CURRENCY', 'MODULE_PAYMENT_AMONEYBOOKERS_PROCESSED_STATUS_ID', 'MODULE_PAYMENT_AMONEYBOOKERS_PENDING_STATUS_ID', 'MODULE_PAYMENT_AMONEYBOOKERS_CANCELED_STATUS_ID', 'MODULE_PAYMENT_AMONEYBOOKERS_TMP_STATUS_ID', 'MODULE_PAYMENT_AMONEYBOOKERS_ICONS', 'MODULE_PAYMENT_AMONEYBOOKERS_SORT_ORDER', 'MODULE_PAYMENT_AMONEYBOOKERS_ALLOWED', 'MODULE_PAYMENT_AMONEYBOOKERS_ZONE', 'MODULE_PAYMENT_AMONEYBOOKERS_NEG_SHIPPING'
        // Hendrik - 2010-08-09 - exlusion config for shipping modules
        );
    }
