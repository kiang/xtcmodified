<?php
/* -----------------------------------------------------------------------------------------
   $Id: cash.php 1200 2010-08-23 14:51:10Z dokuman $
...
class cash {
    ...
    function keys() {
        return array('MODULE_PAYMENT_CASH_STATUS', 'MODULE_PAYMENT_CASH_ALLOWED', 'MODULE_PAYMENT_CASH_ZONE', 'MODULE_PAYMENT_CASH_ORDER_STATUS_ID', 'MODULE_PAYMENT_CASH_SORT_ORDER', 'MODULE_PAYMENT_CASH_NEG_SHIPPING'); // Hendrik - 2010-07-15 - exlusion config for shipping modules
