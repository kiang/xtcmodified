...
class cc {
    ...
    function selection() {
        ...
        // cards
        if (strtolower(MODULE_PAYMENT_CC_ACCEPT_VISA) == 'true') $this->accepted.= xtc_image(DIR_WS_ICONS . 'cc_visa.jpg');
        if (strtolower(MODULE_PAYMENT_CC_ACCEPT_MASTERCARD) == 'true') $this->accepted.= xtc_image(DIR_WS_ICONS . 'cc_mastercard.jpg');
        if (strtolower(MODULE_PAYMENT_CC_ACCEPT_AMERICANEXPRESS) == 'true') $this->accepted.= xtc_image(DIR_WS_ICONS . 'cc_amex.jpg');
        if (strtolower(MODULE_PAYMENT_CC_ACCEPT_DINERSCLUB) == 'true') $this->accepted.= xtc_image(DIR_WS_ICONS . 'cc_diners.jpg');
        if (strtolower(MODULE_PAYMENT_CC_ACCEPT_DISCOVERNOVUS) == 'true') $this->accepted.= xtc_image(DIR_WS_ICONS . 'cc_discover.jpg');
        if (strtolower(MODULE_PAYMENT_CC_ACCEPT_JCB) == 'true') $this->accepted.= xtc_image(DIR_WS_ICONS . 'cc_jcb.jpg');
        if (strtolower(MODULE_PAYMENT_CC_ACCEPT_OZBANKCARD) == 'true') $this->accepted.= '';
    ...
    function pre_confirmation_check() {
        ...
        switch ($result) {
            ...
            case -8:
                $cards = '';
                if (strtolower(MODULE_PAYMENT_CC_ACCEPT_VISA) == 'true') $cards.= ' Visa,';
                if (strtolower(MODULE_PAYMENT_CC_ACCEPT_MASTERCARD) == 'true') $cards.= ' Master Card,';
                if (strtolower(MODULE_PAYMENT_CC_ACCEPT_AMERICANEXPRESS) == 'true') $cards.= ' American Express,';
                if (strtolower(MODULE_PAYMENT_CC_ACCEPT_DINERSCLUB) == 'true') $cards.= ' Diners Club,';
                if (strtolower(MODULE_PAYMENT_CC_ACCEPT_DISCOVERNOVUS) == 'true') $cards.= ' Discover,';
                if (strtolower(MODULE_PAYMENT_CC_ACCEPT_JCB) == 'true') $cards.= ' JCB,';
                if (strtolower(MODULE_PAYMENT_CC_ACCEPT_OZBANKCARD) == 'true') $cards.= ' Australian BankCard,';
