<?php
/* -----------------------------------------------------------------------------------------
   $Id: paypal_ipn.php 1200 2010-08-23 14:51:10Z dokuman $
...
class paypal_ipn {
    ...
    /**************************************************************/
    function keys() {
        return array('MODULE_PAYMENT_PAYPAL_IPN_STATUS', 'MODULE_PAYMENT_PAYPAL_IPN_ALLOWED', 'MODULE_PAYMENT_PAYPAL_IPN_ID', 'MODULE_PAYMENT_PAYPAL_IPN_CURRENCY', 'MODULE_PAYMENT_PAYPAL_IPN_ZONE', 'MODULE_PAYMENT_PAYPAL_IPN_TMP_STATUS_ID',
        //'MODULE_PAYMENT_PAYPAL_IPN_ORDER_STATUS_ID',
        'MODULE_PAYMENT_PAYPAL_IPN_SORT_ORDER', 'MODULE_PAYMENT_PAYPAL_IPN_IMAGE', 'MODULE_PAYMENT_PAYPAL_IPN_CO_BACK', 'MODULE_PAYMENT_PAYPAL_IPN_CO_BORD', 'MODULE_PAYMENT_PAYPAL_IPN_CO_SITE', 'MODULE_PAYMENT_PAYPAL_IPN_CBT', 'MODULE_PAYMENT_PAYPAL_IPN_RETURN',
        //'MODULE_PAYMENT_PAYPAL_IPN_NOTIFY',
        'MODULE_PAYMENT_PAYPAL_IPN_CANCEL', 'MODULE_PAYMENT_PAYPAL_IPN_USE_CHECKOUT', 'MODULE_PAYMENT_PAYPAL_IPN_USE_EMAIL', 'MODULE_PAYMENT_PAYPAL_IPN_USE_ACCOUNT', 'MODULE_PAYMENT_PAYPAL_IPN_USE_SANDBOX', 'MODULE_PAYMENT_PAYPAL_IPN_SBID', 'MODULE_PAYMENT_PAYPAL_IPN_NEG_SHIPPING'); // Hendrik - 2010-08-11 - exlusion config for shipping modules
