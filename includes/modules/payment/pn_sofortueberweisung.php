        ...
        */
        ...
        switch (MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_IMAGE) {
            case 'Logo & Text':
                ...
                if (MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_KS_STATUS == 'True') $title = str_replace('{{image}}', $image, sprintf(MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_TEXT_DESCRIPTION_CHECKOUT_PAYMENT_IMAGE, MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_KS_TEXT_DESCRIPTION_CHECKOUT_PAYMENT_TEXT));
                else $title = str_replace('{{image}}', $image, sprintf(MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_TEXT_DESCRIPTION_CHECKOUT_PAYMENT_IMAGE, MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_TEXT_DESCRIPTION_CHECKOUT_PAYMENT_TEXT));
                break;
            case 'Logo':
                $image = xtc_image(sprintf('lang/%s/modules/payment/images/sofortueberweisung_logo.gif', $_SESSION['language']), MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_TEXT_DESCRIPTION_CHECKOUT_PAYMENT_IMAGEALT);
                ...
                break;
            case 'Infographic':
                if (MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_KS_STATUS == 'True') $image = xtc_image(sprintf('lang/%s/modules/payment/images/sofortueberweisungk_banner.jpg', $_SESSION['language']), MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_TEXT_DESCRIPTION_CHECKOUT_PAYMENT_IMAGEALT);
                else $image = xtc_image(sprintf('lang/%s/modules/payment/images/sofortueberweisung_info.gif', $_SESSION['language']), MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_TEXT_DESCRIPTION_CHECKOUT_PAYMENT_IMAGEALT);
                $title = str_replace('{{image}}', $image, sprintf(MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_TEXT_DESCRIPTION_CHECKOUT_PAYMENT_IMAGE, ''));
                break;
            }
        ...
        function payment_action() {
            ...
            if (ENABLE_SSL == true) $server = HTTPS_SERVER;
            else $server = HTTP_SERVER;
        ...
        function keys() {
            return array('MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_STATUS', 'MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_KS_STATUS', 'MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_ALLOWED', 'MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_USER_ID', 'MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_PROJECT_ID', 'MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_PROJECT_PASSWORD', 'MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_PROJECT_NOTIF_PASSWORD', 'MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_ZONE', 'MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_REASON_1', 'MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_TEXT_REASON_2', 'MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_IMAGE', 'MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_TMP_STATUS_ID', 'MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_UNC_STATUS_ID', 'MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_ORDER_STATUS_ID', 'MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_RECEIVED_STATUS_ID', 'MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_LOSS_STATUS_ID', 'MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_SORT_ORDER', 'MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_NEG_SHIPPING'); // Hendrik - 2010-08-11 - exlusion config for shipping modules
