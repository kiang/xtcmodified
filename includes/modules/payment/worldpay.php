...
class worldpay {
    ...
    function process_button() {
        ...
        if (MODULE_PAYMENT_WORLDPAY_USEPREAUTH == 'True') $process_button_string.= xtc_draw_hidden_field('authMode', MODULE_PAYMENT_WORLDPAY_PREAUTH);
