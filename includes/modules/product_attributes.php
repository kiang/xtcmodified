<?php
/* -----------------------------------------------------------------------------------------
   $Id: product_attributes.php 1579 2010-12-14 10:16:20Z web28 $
...
if ($product->getAttributesCount() > 0) {
    ...
    while ($products_options_name = xtc_db_fetch_array($products_options_name_query, true)) {
        ...
        //BOF - web28 - 2010-12-14  - add OPTIONS SORTORDER for using in template
        $products_options_data[$row] = array('NAME' => $products_options_name['products_options_name'], 'ID' => $products_options_name['products_options_id'], 'SORTORDER' => $products_options_name['products_options_sortorder'], 'DATA' => '');
        //EOF - web28 - 2010-12-14  - add OPTIONS SORTORDER for using in template
