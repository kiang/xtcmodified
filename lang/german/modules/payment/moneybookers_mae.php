...
define('MODULE_PAYMENT_MONEYBOOKERS_MAE_NEG_SHIPPING_TITLE', 'Ausschluß bei Versandmodulen');
define('MODULE_PAYMENT_MONEYBOOKERS_MAE_NEG_SHIPPING_DESC', 'Dieses Zahlungsmodul deaktivieren wenn Versandmodul gew&auml;hlt (Komma separierte Liste)');
