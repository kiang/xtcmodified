<?php
/* --------------------------------------------------------------
   $Id: categories.php 30 2006-12-27 16:34:34Z sun $
...
define('TEXT_CHOOSE_INFO_TEMPLATE', '商品说明样版：');
define('TEXT_CHOOSE_OPTIONS_TEMPLATE', '商品选项样版：');
...
define('TEXT_CHOOSE_INFO_TEMPLATE','商品说明样版');
define('TEXT_SELECT','--请选择--');
define('TEXT_CHOOSE_OPTIONS_TEMPLATE','商品属性样板');
define('SAVE_ENTRY','存贮?');
...
// sp2.2
define('HEADING_GROUP_PERMISSIONS','群组权限');
define('HEADING_GENERAL','一般');
define('TEXT_AVERAGE_STOCK','库存警示:');
