<?php
/* --------------------------------------------------------------
   $Id: china.php 36 2006-12-28 13:19:07Z sun $
...
// on RedHat6.0 I used 'zh_CN'
// on FreeBSD 4.0 I use 'zh_CN.UTF-8'
...
define('BOX_HEADING_MODULES','模组');
define('BOX_HEADING_ZONE','地区 / 税');
define('BOX_HEADING_CUSTOMERS','会员');
...
define('BOX_PRODUCTS_ATTRIBUTES', '商品选项');
define('BOX_PRODUCTS_OPTIONS','商品属性');
...
define('BOX_HEADING_COUPON_ADMIN','折价券');
...
// Description for subscribe in the newsletter
...
//SP2.2 
define('BOX_STOCKS_TRAFFIC','库存警示规则');
define('TEXT_DISPLAY_NUMBER_OF_STOCKS_TRAFFIC','显示 <b>%d</b> 到 <b>%d</b> (总共有 <b>%d</b> 警示规则)');
define('_MODULES_SORT_ORDER_TITLE ','显示顺位.'); 
define('_MODULES_SORT_ORDER_DESC', '显示排序后的顺位.由小至大显示.'); 
define('_MODULES_ZONE_TITLE','模组使用区域'); 
define('_MODULES_ZONE_DESC','设定区域后， 此模组只会用于这些区域.'); 
define('_MODULES_ZONE_ALLOWED_TITLE', '使用区域'); 
define('_MODULES_ZONE_ALLOWED_DESC', '请输入可以使用此机制的各区域国际缩写名称<b>以(, )逗号区隔</b>(例如TW, CN(什么都不填就代表你允许所有的区域都可以使用这项机制))');
define('_MODULES_PAYMENT_FEE_TITLE', '手续费'); 
define('_MODULES_PAYMENT_FEE_DESC', '使用此方式的手续费'); 
define('_MODULES_SET_ORDER_STATUS_TITLE' ,'设定订单状态'); 
define('_MODULES_SET_ORDER_STATUS_DESC', '设定当选用此模组时的订单状态'); 
define('_MODULES_TAX_ZONE_TITLE','税区'); 
define('_MODULES_TAX_ZONE_DESC', '选择要加计何项税率');
define('TEXT_INFO_DEFAULT_CURRENCY', '预设货币');
?>