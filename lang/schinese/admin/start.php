...
// text for Warnings:
define('TEXT_FILE_WARNING', '<b>注意:</b><br />下列文件允许被写入，基于安全的理由，在 unix-like 环境请将文件权限改为<b>(644)</b> 在 Windows 环境请将文件设成<b>唯读</b>');
define('TEXT_FOLDER_WARNING', '<b>注意:</b><br />下列资料夹必须为可读写，在 unix-like 环境请将资料夹权限改为 <b>(777)</b>，在 Winodws 环境请将资料夹改为<b>可读写</b>');
...
// main heading
define('HEADING_TITLE', 'Welcome to the Admin Area');define('HEADING_TITLE_SEARCH', 'Order-Nr.:');
define('HEADING_TITLE_STATUS', 'Status:');
define('TABLE_HEADING_AFTERBUY', 'Afterbuy'); //Dokuman - 2009-05-27 - added missing definition
define('TABLE_HEADING_CUSTOMERS', 'Customers');
define('TABLE_HEADING_ORDER_TOTAL', 'Total value');
