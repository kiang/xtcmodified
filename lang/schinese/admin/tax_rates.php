...
define('TEXT_INFO_CLASS_TITLE', '税别标题：');
define('TEXT_INFO_COUNTRY_NAME', '国家：');
define('TEXT_INFO_ZONE_NAME', '地区：');
define('TEXT_INFO_TAX_RATE', '税率 (%):');
define('TEXT_INFO_TAX_RATE_PRIORITY', '优先权：');
define('TEXT_INFO_RATE_DESCRIPTION', '描述：');
define('TEXT_INFO_INSERT_INTRO', '请输入税别的相关资料');
define('TEXT_INFO_DELETE_INTRO', '确定要删除这个税率？');
define('TEXT_INFO_HEADING_NEW_TAX_RATE', '新增税率');
define('TEXT_INFO_HEADING_EDIT_TAX_RATE', '编辑税率');
