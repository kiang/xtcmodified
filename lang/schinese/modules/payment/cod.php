...
define('MODULE_PAYMENT_COD_TEXT_TITLE', '货到付款');
define('MODULE_PAYMENT_COD_TEXT_DESCRIPTION', '货到付款');
define('MODULE_PAYMENT_COD_TEXT_INFO', '第一次交易之客户，请另选其它付款方式。');
...
define('MODULE_PAYMENT_COD_STATUS_TITLE', '启用货到付款模组');
define('MODULE_PAYMENT_COD_STATUS_DESC', '您确定要启用货到付款模组？');
