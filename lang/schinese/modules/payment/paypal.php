...
define('MODULE_PAYMENT_PAYPAL_ID_TITLE', 'eMail地址');
define('MODULE_PAYMENT_PAYPAL_ID_DESC', '您在PayPal注册的eMail地址');
define('MODULE_PAYMENT_PAYPAL_CURRENCY_TITLE', '交易货币');
define('MODULE_PAYMENT_PAYPAL_CURRENCY_DESC', '信用卡交易时使用的货币');
define('MODULE_PAYMENT_PAYPAL_TMP_STATUS_ID_TITLE','设置处理中状态');
define('MODULE_PAYMENT_PAYPAL_TMP_STATUS_ID_DESC','设置这笔交易尚在处理中的状态');
define('MODULE_PAYMENT_PAYPAL_USE_CURL_TITLE', 'cURL');
define('MODULE_PAYMENT_PAYPAL_USE_CURL_DESC', '使用 cURL 或是重新导向.');
