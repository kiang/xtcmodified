...
/* -----------------------------------------------------------------------------------------
   ...
   ---------------------------------------------------------------------------------------*/
define('MODULE_SHIPPING_FLAT_TEXT_TITLE', '同一运费');
define('MODULE_SHIPPING_FLAT_TEXT_DESCRIPTION', '所有订单使用相同的运送费率');
define('MODULE_SHIPPING_FLAT_TEXT_WAY', '最佳');
define('MODULE_SHIPPING_FLAT_STATUS_TITLE', '使用同一运费');
define('MODULE_SHIPPING_FLAT_STATUS_DESC', '确定要启动同一运费？');
...
define('MODULE_SHIPPING_FLAT_COST_TITLE', '同一运费金额');
define('MODULE_SHIPPING_FLAT_COST_DESC', '设置使用同一运费之金额');
