...
define('MODULE_SHIPPING_SELFPICKUP_TEXT_TITLE', 'Self Pickup.');define('MODULE_SHIPPING_SELFPICKUP_TEXT_DESCRIPTION', '消费者至商店自行取货');
define('MODULE_SHIPPING_SELFPICKUP_SORT_ORDER', '订单排序');
define('MODULE_SHIPPING_SELFPICKUP_TEXT_TITLE', 'Self Pickup.');
define('MODULE_SHIPPING_SELFPICKUP_TEXT_WAY', '消费者至商店自行取货');
...
define('MODULE_SHIPPING_SELFPICKUP_STATUS_TITLE', '启用到店自取');
define('MODULE_SHIPPING_SELFPICKUP_STATUS_DESC', '同意启用到店自取模组？');
