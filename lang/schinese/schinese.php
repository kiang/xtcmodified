<?php
/* -----------------------------------------------------------------------------------------
   $Id: schinese.php 35 2006-12-28 13:17:39Z sun $
...
@setlocale(LC_TIME, 'zh_CN@UTF-8', 'zh_cn', 'zh-cn', 'zh_CN', 'zh-CN', 'zh_cn.UTF-8', 'zh-cn.UTF-8' , 'zh_CN.UTF-8', 'zh-CN.UTF-8' , 'China');
...
define('BOX_HEADING_ADD_PRODUCT_ID','放到购物车');
...
define('JS_ERROR_SUBMITTED', '此表单已经送出，请按 ok 后等待处理');
...
define('ENTRY_DATE_OF_BIRTH_ERROR', '请确认生日的格式 日.月.年 (范例： 22.05.2001) ');
define('ENTRY_DATE_OF_BIRTH_TEXT', '* (范例： 22.05.2001)');
define('ENTRY_EMAIL_ADDRESS_ERROR', '电子邮件不可少于 ' . ENTRY_EMAIL_ADDRESS_MIN_LENGTH . ' 个字');
define('ENTRY_EMAIL_ADDRESS_CHECK_ERROR', '电子邮件格式错误 - 请重新输入');
define('ENTRY_EMAIL_ADDRESS_ERROR_EXISTS', '这个电子邮件已有人注册使用，请重新输入！');
define('ENTRY_EMAIL_ADDRESS_TEXT', '*');
define('ENTRY_STREET_ADDRESS_ERROR', '地址不可少于' . ENTRY_STREET_ADDRESS_MIN_LENGTH . ' 个字');
...
define('ENTRY_STATE_ERROR_SELECT', '请从下拉式菜单中选取省／直辖市...');
...
define('IMAGE_BUTTON_WRITE_REVIEW', '编写反应');
define('IMAGE_BUTTON_ADMIN', '管理');
define('IMAGE_BUTTON_PRODUCT_EDIT', '编辑商品');
define('IMAGE_BUTTON_LOGIN', '会员登入');
...
define('WARNING_PRIMARY_ADDRESS_DELETION', '预设的通讯地址不能删除，请选择其他通讯地址--设置成预设地址后--才能删除');
define('ERROR_NONEXISTING_ADDRESS_BOOK_ENTRY', '通讯录资料不存在');
define('ERROR_ADDRESS_BOOK_FULL', '通讯录笔数已满，请先删除不需要的地址才能再新增通讯录');
...
define('AT_LEAST_ONE_INPUT', '搜寻表单内至少必须填一个栏位：<br />关键字至少要两个字<br />价格范围<br />');
...
define('TEXT_LOGIN_ERROR', '<font color="#ff0000"><b>请注意：</b></font>「电子邮件地址」或是「密码」有错误...请重新输入');
define('TEXT_NO_EMAIL_ADDRESS_FOUND', '<font color="#ff0000"><b>请注意：</b></font>您输入的电子邮件尚未注册、请再试试...');
...
define('OUT_OF_STOCK_CANT_CHECKOUT', '标示' . STOCK_MARK_PRODUCT_OUT_OF_STOCK . ' 的商品表示目前库存量可能不太够，可能会缺货！请勿大量订购，谢谢！');
define('OUT_OF_STOCK_CAN_CHECKOUT', '标示' . STOCK_MARK_PRODUCT_OUT_OF_STOCK . ' 的商品，目前库存量可能已经不够，如果您仍然愿意等待坚持要买...可以继续完成结帐程序，我们会在补足商品后立即将您所订购的商品寄出。谢谢！');

define('MINIMUM_ORDER_VALUE_NOT_REACHED_1', '您需要订购的最低的数量是：');
define('MINIMUM_ORDER_VALUE_NOT_REACHED_2', ' <br />请再增加订购数量：');
define('MAXIMUM_ORDER_VALUE_REACHED_1', '您所订购的，已经超过最低订购量：');
define('MAXIMUM_ORDER_VALUE_REACHED_2', '<br /> 您也可以降低订购数量: ');
...
define('TEXT_NEWSLETTER','您希望收到最新消息吗？<br />订阅我们的电子报后，您可以随时掌握网站上的最新好康喔！');
define('TEXT_EMAIL_INPUT','您的E-Mail已经注册了<br />接着您将会收到一封确认信函，请跟着信中的指示点选连结来完成订阅的程序。');

define('TEXT_WRONG_CODE','<font color="FF0000">请重新填写电子邮件与安全码栏位</font>');
define('TEXT_EMAIL_EXIST_NO_NEWSLETTER','<font color="FF0000">这个电子邮件经注册，但是还没启用！</font>');
define('TEXT_EMAIL_EXIST_NEWSLETTER','<font color="FF0000">这个电子邮件经注册，而且已经启用！</font>');
define('TEXT_EMAIL_NOT_EXIST','<font color="FF0000">这个电子邮件经注册，但是没有订阅电子报！</font>');
define('TEXT_EMAIL_DEL','您的电子邮件已经加到我们的电子报订阅列表中');
define('TEXT_EMAIL_DEL_ERROR','<font color="FF0000">删除资料过程发生错误，请联络管理员！</font>');
define('TEXT_EMAIL_ACTIVE','<font color="FF0000">您已经完成订阅我们的电子报！</font>');
define('TEXT_EMAIL_ACTIVE_ERROR','<font color="FF0000">订阅过程发生错误，您的订阅作业尚未生效！</font>');
define('TEXT_EMAIL_SUBJECT','您的电子报帐号');

define('TEXT_CUSTOMER_GUEST','访客');

define('TEXT_LINK_MAIL_SENDED','补发密码的作业须经过本人的确认<br />你会在注册的信箱中收到确认的连结。<font color=red">（请注意：奇摩信箱有时会寄到垃圾信箱中）</font><br />请点击信中的连结，让我们确认是你的信箱没错。<br />随后将会收到密码');
define('TEXT_PASSWORD_MAIL_SENDED','您将会在几分钟内收到新的密码<br />请在下次登入后立即变更！');
define('TEXT_CODE_ERROR','请重新输入安全码栏位....请注意大小写！');
define('TEXT_EMAIL_ERROR','请重新输入电子邮件！');
define('TEXT_NO_ACCOUNT','抱歉，您查询密码的作业程序错误、有重复或是已经超过确认的时间....请重试！');
...
define('CATEGORIE_NOT_FOUND','没有这个分类');

define('GV_FAQ', '礼券问答集');
define('ERROR_NO_REDEEM_CODE', '您没有输入礼券码');
define('ERROR_NO_INVALID_REDEEM_GV', '错误的礼券码');
define('TABLE_HEADING_CREDIT', '☆使用折扣券');
define('EMAIL_GV_TEXT_SUBJECT', '%s 给你的礼物');
define('MAIN_MESSAGE', '你将寄送价值「%s」的礼券给%s E-mail 是 %s 的人<br />并且附上文字说明如下～<br />（请确认无误后点击送出）<br /><br />亲爱的 %s<br /><br />您已经收到一张价值%s 的礼券，从%s 寄过来的。');
define('REDEEMED_AMOUNT','您所购买的礼券已经成功加入帐号中，礼券的金额为：');
define('REDEEMED_COUPON','您的折扣券已经顺利加入帐册中，可以在你下一次的订购中使用（请注意折扣券的时效）');

define('ERROR_INVALID_USES_USER_COUPON','只有会员可以使用这个折价券(Customers can redeem this coupon only)');
define('ERROR_INVALID_USES_COUPON','只有顾客可以使用这个折价券');
define('TIMES',' 次');
define('ERROR_INVALID_STARTDATE_COUPON','您的折价券目前无法使用');
define('ERROR_INVALID_FINISDATE_COUPON','您的折价券已经过期罗！');
...
define('TEXT_COUPON_HELP_HEADER', '恭喜您！您已经兑换了一张折价券');
define('TEXT_COUPON_HELP_NAME', '<br /><br />折价券名称： %s');
define('TEXT_COUPON_HELP_FIXED', '<br /><br />通过这个折价券的订单可以享有 %s 折扣');
define('TEXT_COUPON_HELP_MINORDER', '<br /><br />您的订单金额必须超过 %s 才能使用这个折价券');
define('TEXT_COUPON_HELP_FREESHIP', '<br /><br />通过这个折价券的订单可以享有免运费的待遇');
define('TEXT_COUPON_HELP_DESC', '<br /><br />折价券说明： %s');
define('TEXT_COUPON_HELP_DATE', '<br /><br />折价券有效期间介于 %s 与 %s');
define('TEXT_COUPON_HELP_RESTRICT', '<br /><br />产品、类别限制');
define('TEXT_COUPON_HELP_CATEGORIES', '类别');
define('TEXT_COUPON_HELP_PRODUCTS', '产品');

// VAT ID
define('ENTRY_VAT_TEXT','* 仅使用于德国及欧盟');
define('ENTRY_VAT_ERROR', '选择的税区编码(VatID)目前无法通过检验！请填入正确资料或是保持空白。');
define('MSRP','网络售价：');
...
define('_MODULE_INVALID_SHIPPING_ZONE', '很抱歉商品无法寄送至这个国家.');
define('_MODULE_UNDEFINED_SHIPPING_RATE', '该区域运费无法计算.');
?>