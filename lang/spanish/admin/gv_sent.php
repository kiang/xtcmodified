...
/* -----------------------------------------------------------------------------------------
   ...
   Released under the GNU General Public License
   ---------------------------------------------------------------------------------------*/
define('HEADING_TITLE', 'Vale de Regalo \ 's enviados ");

define('TABLE_HEADING_SENDERS_NAME', 'Nombre de los remitentes');
define('TABLE_HEADING_VOUCHER_VALUE', 'Valor Bono');
define('TABLE_HEADING_VOUCHER_CODE', 'Código de Bono');
define('TABLE_HEADING_DATE_SENT', 'Fecha de envío');
define('TABLE_HEADING_ACTION', 'Acción');

define('TEXT_INFO_SENDERS_ID', 'ID del remitente:');
define('TEXT_INFO_AMOUNT_SENT', 'La cantidad enviada:');
define('TEXT_INFO_DATE_SENT', 'Fecha de envío:');
define('TEXT_INFO_VOUCHER_CODE', 'Código de Bono:');
define('TEXT_INFO_EMAIL_ADDRESS', 'E-Mail:');
define('TEXT_INFO_DATE_REDEEMED', 'Fecha Redimidos:');
define('TEXT_INFO_IP_ADDRESS', 'Dirección IP:');
define('TEXT_INFO_CUSTOMERS_ID', 'El ID de cliente:');
define('TEXT_INFO_NOT_REDEEMED', 'No Redimidos'););
