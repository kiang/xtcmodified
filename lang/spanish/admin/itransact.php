...
/* --------------------------------------------------------------
   ...
   --------------------------------------------------------------*/
define('HEADING_TITLE', 'Abra el Panel de control de transacciones');
define('SUB_BAR_TITLE', 'Haga clic en la imagen a continuación. Su puerta de enlace ID y la contraseña son obligatorios.');
