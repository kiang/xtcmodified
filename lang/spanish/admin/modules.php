...
define('HEADING_TITLE_MODULES_ORDER_TOTAL', 'Orden total de módulos');
define('TABLE_HEADING_MODULES', 'Módulos');
define('TABLE_HEADING_SORT_ORDER', 'Ordenar');
define('TABLE_HEADING_STATUS', 'Estatus');
define('TABLE_HEADING_ACTION', 'Acción');
define('TEXT_MODULE_DIRECTORY', 'Módulo de Directorio:');
define('TABLE_HEADING_FILENAME', 'El nombre del módulo (para uso interno)');
