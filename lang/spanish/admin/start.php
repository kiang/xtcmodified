...
/* --------------------------------------------------------------
   ...
   --------------------------------------------------------------*/
define('ATTENTION_TITLE', '! ATENCION !');
// text for Warnings:
define('TEXT_FILE_WARNING', '<b>ADVERTENCIA:</b><br>A raiz de los archivos de escritura. Por favor, cambie los permisos de los archivos de este debido a razones de seguridad. <b>(444)</b> in unix, <b>(read-only)</b> in Win32.');
define('TEXT_FOLDER_WARNING', '<b>ADVERTENCIA:</b><br>A raiz de las carpetas debe ser de escritura. Por favor, cambie los permisos de estas carpetas. <b>(777)</b> in unix, <b>(read-write)</b> in Win32.');
...
// main heading
define('HEADING_TITLE', 'Bienvenido');
// users online
