...
define('MODULE_SHIPPING_FREEAMOUNT_ALLOWED_TITLE', 'Zonas de Permitido');
define('MODULE_SHIPPING_FREEAMOUNT_ALLOWED_DESC', 'Por favor, introduzca las zonas <b>por separado</b> que deben estar autorizados a utilizar este módulo (por ejemplo, AT, DE (dejar vacío si desea permitir que todas las zonas))');
