...
define('TEXT_CHOOSE_INFO_TEMPLATE', '商品說明樣版：');
define('TEXT_CHOOSE_OPTIONS_TEMPLATE', '商品選項樣版：');
...
define('TEXT_CHOOSE_INFO_TEMPLATE','商品說明樣版');
define('TEXT_SELECT','--請選擇--');
define('TEXT_CHOOSE_OPTIONS_TEMPLATE','商品屬性樣板');
...
// sp2.2
define('HEADING_GROUP_PERMISSIONS','群組權限');
define('HEADING_GENERAL','一般');
define('TEXT_AVERAGE_STOCK','庫存警示:');
