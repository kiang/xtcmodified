...
define('PRODUCT_IMAGE_THUMBNAIL_DROP_SHADDOW_TITLE' , '縮圖(小)：加陰影<br /><br /><img src="images/config_shadow.gif">');
define('PRODUCT_IMAGE_THUMBNAIL_DROP_SHADDOW_DESC' , '小圖加上陰影的效果<br />預設值： (3,333333,FFFFFF)<br /><br />設定方法：&nbsp;(陰影寬度, 陰影顏色, 陰影底色)');
...
define('PRODUCT_IMAGE_INFO_DROP_SHADDOW_TITLE' , '內容圖(中)：加陰影');
define('PRODUCT_IMAGE_INFO_DROP_SHADDOW_DESC' , '內容圖加上陰影的效果<br />預設值： (3,333333,FFFFFF)<br /><br />設定方法：&nbsp;(陰影寬度, 陰影顏色, 陰影底色)');
...
define('PRODUCT_IMAGE_POPUP_DROP_SHADDOW_TITLE' , '彈出視窗圖(大)：加陰影');
define('PRODUCT_IMAGE_POPUP_DROP_SHADDOW_DESC' , '彈出視窗圖加上陰影的效果<br />預設值： (3,333333,FFFFFF)<br /><br />設定方法：&nbsp;(陰影寬度, 陰影顏色, 陰影底色)');
...
define('SECURITY_CODE_LENGTH_TITLE','禮券密碼長度');
define('SECURITY_CODE_LENGTH_DESC','禮券的安全密碼字數');
...
define('STORE_OWNER_VAT_ID_DESC' , '商店擁有者的 Vat-ID');
...
define('ACTIVATE_STOCKS_TRAFFIC_TITLE','啟用庫存警示?');
define('ACTIVATE_STOCKS_TRAFFIC_DESC','啟用庫存警示圖示，藉以判斷目前該商品的庫存現況。');
?>