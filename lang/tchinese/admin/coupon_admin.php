...
define('BUTTON_DELETE_NO_CONFIRM', '直接刪除');
define('TEXT_NONE', '沒有限制');
define('TEXT_COUPON_DELETE', '刪除');
define('TEXT_COUPON_STATUS', '狀態');
define('TEXT_COUPON_DETAILS', '折價券細節');
define('TEXT_COUPON_EMAIL', '發送信件');
define('TEXT_COUPON_OVERVIEW', '摘要');
define('TEXT_COUPON_EMAIL_PREVIEW', '確認');
define('TEXT_COUPON_MINORDER', '訂單金額下限');
define('TEXT_VIEW', '列表');
define('TEXT_VIEW_SHORT', '顯示');
?>