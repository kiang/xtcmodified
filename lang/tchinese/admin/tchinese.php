<?php
/* --------------------------------------------------------------
   $Id: taiwan.php 115 2007-01-18 13:39:10Z sun $
...
// on RedHat6.0 I used 'zh_TW'
// on FreeBSD 4.0 I use 'zh_TW.UTF-8'
...
define('BOX_HEADING_CUSTOMERS','會員');
...
define('BOX_PRODUCTS_ATTRIBUTES', '商品選項');
define('BOX_PRODUCTS_OPTIONS','商品屬性');
...
define('BOX_HEADING_COUPON_ADMIN','折價券');
...
// SP2.2
define('BOX_STOCKS_TRAFFIC','庫存警示規則');
define('TEXT_DISPLAY_NUMBER_OF_STOCKS_TRAFFIC','顯示 <b>%d</b> 到 <b>%d</b> (總共有 <b>%d</b> 警示規則)');
define('_MODULES_SORT_ORDER_TITLE','顯示順位.');
define('_MODULES_SORT_ORDER_DESC','顯示排序後的順位. 由小至大顯示.');
define('_MODULES_ZONE_TITLE','模組使用區域');
define('_MODULES_ZONE_DESC','設定區域後，此模組只會用於這些區域.');
define('_MODULES_ZONE_ALLOWED_TITLE','使用區域');
define('_MODULES_ZONE_ALLOWED_DESC','請輸入可以使用此機制的各區域國際縮寫名稱 <b>以(,)逗號區隔</b> (例如 TW,CN (什麼都不填就代表你允許所有的區域都可以使用這項機制))');
define('_MODULES_PAYMENT_FEE_TITLE','手續費');
define('_MODULES_PAYMENT_FEE_DESC','使用此方式的手續費');
define('_MODULES_SET_ORDER_STATUS_TITLE','設定訂單狀態');
define('_MODULES_SET_ORDER_STATUS_DESC','設定當選用此模組時的訂單狀態');
define('_MODULES_TAX_ZONE_TITLE' , '稅區');
define('_MODULES_TAX_ZONE_DESC' , '選擇要加計何項稅率');
define('TEXT_INFO_DEFAULT_CURRENCY','預設貨幣');
?>