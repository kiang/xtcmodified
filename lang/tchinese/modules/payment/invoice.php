...
/* -----------------------------------------------------------------------------------------
   ...
   ---------------------------------------------------------------------------------------*/
define('MODULE_PAYMENT_INVOICE_TEXT_DESCRIPTION', '發票請款(月結)');
define('MODULE_PAYMENT_INVOICE_TEXT_TITLE', '發票請款(月結)');
define('MODULE_PAYMENT_INVOICE_TEXT_INFO', '');
define('MODULE_PAYMENT_INVOICE_STATUS_TITLE', '啟用發票請款(月結)');
define('MODULE_PAYMENT_INVOICE_STATUS_DESC', '您同意啟用發票請款(月結)？');
...
define('MODULE_PAYMENT_INVOICE_MIN_ORDER_TITLE', '單筆訂單金額下限');
define('MODULE_PAYMENT_INVOICE_MIN_ORDER_DESC', '客戶要能使用該付款方式，單筆訂單必須高於這個金額');
