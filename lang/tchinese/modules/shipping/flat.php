<?php
/* --------------------------------------------------------------
   $Id: flat.php 115 2007-01-18 13:39:10Z sun $
...
define('MODULE_SHIPPING_FLAT_TEXT_TITLE', '同一運費');
define('MODULE_SHIPPING_FLAT_TEXT_DESCRIPTION', '所有訂單使用相同的運送費率');
define('MODULE_SHIPPING_FLAT_TEXT_WAY', '最佳');

define('MODULE_SHIPPING_FLAT_STATUS_TITLE' , '使用同一運費');
define('MODULE_SHIPPING_FLAT_STATUS_DESC' , '確定要啟動同一運費？');
define('MODULE_SHIPPING_FLAT_COST_TITLE' , '同一運費金額');
define('MODULE_SHIPPING_FLAT_COST_DESC' , '設定使用同一運費之金額');
