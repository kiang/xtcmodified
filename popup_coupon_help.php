<?php
/* -----------------------------------------------------------------------------------------
   $Id: popup_coupon_help.php 1510 2010-11-22 13:24:04Z dokuman $
...
if (xtc_not_null($coupon_desc['coupon_description'])) $text_coupon_help.= sprintf(TEXT_COUPON_HELP_DESC, $coupon_desc['coupon_description']);
...
if (!isset($cats) || $cats == '') $cats = '<br />NONE';
...
if (!isset($prods) || $prods == '') $prods = '<br />NONE';
