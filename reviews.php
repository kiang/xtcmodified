<?php
/* -----------------------------------------------------------------------------------------
   $Id: reviews.php 1551 2010-12-04 11:23:46Z dokuman $
...
$reviews_split = new splitPageResults($reviews_query_raw, isset($_GET['page']) ? $_GET['page'] : 1, MAX_DISPLAY_NEW_REVIEWS);
