<?php
// $Id: wsdl_iclear_order.php 1545 2010-11-29 12:01:03Z gtb-modified $
/*
...
$server->wsdl->addComplexType('Address', 'complexType', 'array', 'all', '', array('addrAnrede' => array('name' => 'addrAnrede', 'type' => 'xsd:string'), 'addrFirstname' => array('name' => 'addrFirstname', 'type' => 'xsd:string'), 'addrLastname' => array('name' => 'addrLastname', 'type' => 'xsd:string'), 'addrOrgname' => array('name' => 'addrOrgname', 'type' => 'xsd:string'), 'addrStrasse' => array('name' => 'addrStrasse', 'type' => 'xsd:string'), 'addrHausNr' => array('name' => 'addrHausNr', 'type' => 'xsd:string'), 'addrPLZ' => array('name' => 'addrPLZ', 'type' => 'xsd:string'), 'addrOrt' => array('name' => 'addrOrt', 'type' => 'xsd:string'), 'addrLand' => array('name' => 'addrLand', 'type' => 'xsd:string')));
// define incoming basketItem element
$server->wsdl->addComplexType('BasketItem', 'complexType', 'struct', 'all', '', array('itemNr' => array('name' => 'itemNr', 'type' => 'xsd:string'), 'title' => array('name' => 'title', 'type' => 'xsd:string'), 'numOfArtikel' => array('name' => 'numOfArtikel', 'type' => 'xsd:long'), 'priceN' => array('name' => 'priceN', 'type' => 'xsd:string'), 'priceB' => array('name' => 'priceB', 'type' => 'xsd:string'), 'ustSatz' => array('name' => 'ustSatz', 'type' => 'xsd:string'), 'Status' => array('name' => 'Status', 'type' => 'xsd:string')));
// define incoming basketItemList element
$server->wsdl->addComplexType('BasketItemList', 'complexType', 'struct', 'all', '', array('BasketItem' => array('name' => 'BasketItem', 'type' => 'tns:BasketItem')));
$server->register('acceptOrder', array('sessionID' => 'xsd:string', 'basketID' => 'xsd:string', 'currency' => 'xsd:string', 'orderStatus' => 'xsd:long', 'orderStatusMessage' => 'xsd:string', 'deliveryAddress' => 'tns:Address', 'requestID' => 'xsd:string', 'BasketItemList' => 'tns:BasketItemList'), array('requestID' => 'xsd:string', 'status' => 'xsd:long', 'statusMessage' => 'xsd:string', 'shopURL' => 'xsd:string'), 'urn:SH_ICOrderServices', 'urn:SH_ICOrderServices#acceptOrder', 'rpc', 'encoded', 'Iclear shop side order web service');
/**
...
function acceptOrder($sessionID, $basketID, $currency, $orderStatus, $orderStatusMessage, $requestID, $deliveryAddress, $basketItemList) {
    ...
    $wsdlOut = array('sessionID' => $sessionID, 'requestID' => $requestID, 'status' => $orderStatusResponse, 'statusMessage' => $orderStatusMessageResponse, 'shopURL' => $returnURL);
    return $wsdlOut;
}
