...
if (isset($_POST['DB_SERVER'])) {
    ...
    if ($_POST['install_db'] == 1) $inst_db = true;
    else $inst_db = false;
    if ($_POST['install_cfg'] == 1) $config = true;
    else $config = false;
}
...
<tr>
 ...
 ?>
              ...
              <!--p><b><?php //echo TEXT_WS_ROOT;
 ?></b><br />
                <?php //echo xtc_draw_input_field_installer('DIR_FS_DOCUMENT_ROOT', DIR_FS_DOCUMENT_ROOT,'','size=60');
 ?><br />
                <?php //echo TEXT_WS_ROOT_LONG;
 ?></p>
              <p><b><?php //echo TEXT_WS_XTC;
 ?></b><br />
                <?php //echo xtc_draw_input_field_installer('DIR_FS_CATALOG', $local_install_path,'','size=60');
 ?><br />
 ...
 ?></b><br />
                <?php //echo xtc_draw_input_field_installer('DIR_WS_CATALOG', $dir_ws_www_root . '/','','size=60');
 ?><br />
